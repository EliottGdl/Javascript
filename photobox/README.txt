Bonjour, toutes les fonctionnalités demandées ont été réalisées, voici le détail ci-dessous :

1) Lors de l'arrivée sur le site le bouton load permet de charger la première page d'images
2) Les images sont responsives et sont rangées sous forme de petits cadres sur l'écran avec leur titre en dessous
3) On peut cliquer sur suivant et précédent (quand c'est possible) pour changer de page dans la gallerie

On peut aussi cliquer sur une image :
