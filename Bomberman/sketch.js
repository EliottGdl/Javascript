/*
All of this was made by Gandiolle Eliott and Jenin Marius in order
to learn javascript, so it work but its not optimized at all (the function explose for example).

We'll make another version cleaner 
*/
